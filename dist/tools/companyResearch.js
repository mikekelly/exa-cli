...
export function registerCompanyResearchTool(server, config) {
    server.tool("company_research_exa", "Research companies using Exa AI - finds comprehensive information about businesses, organizations, and corporations. Provides insights into company operations, news, financial information, and industry analysis.", {
