...
export function registerCrawlingTool(server, config) {
    server.tool("crawling_exa", "Extract and crawl content from specific URLs using Exa AI - retrieves full text content, metadata, and structured information from web pages. Ideal for extracting detailed content from known URLs.", {
        ...
        try {
            ...
            const response = await axiosInstance.post('/contents', crawlRequest, { timeout: 25000 });
